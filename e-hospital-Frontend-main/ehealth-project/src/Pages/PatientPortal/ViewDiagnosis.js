...
import background from "./con12.webp";

const theme = createTheme();
function ViewDiagnosis(props) {
                                ...
                                <Grid container spacing={2}>
                                  ...
                                  <Grid item xs={12}>
                                    <TextField
                                      ...
                                      type="typeofdiagnosis"
                                      id="typeofdiagnosis"
                                      autoComplete="typeofdiagnosis"
                                    />
                                  </Grid>
